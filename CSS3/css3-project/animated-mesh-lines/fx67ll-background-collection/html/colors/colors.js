! function(t) {
	function e(e) {
		for (var o, a, u = e[0], c = e[1], f = e[2], p = 0, s = []; p < u.length; p++) a = u[p], r[a] && s.push(r[a][
			0
		]), r[a] = 0;
	...
	25: function(t, e, n) {
		...
		P.position.x = -P.basePosition * (y.a.isMobile ? .5 : .55), P.position.y = y.a.isMobile ? -1.2 : -.9, P
			.position.z = 2, P.rotation.x = -.1;
				...
				return m(e, c["a"]), n = e, (o = [{
					...
					value: function() {
						if (!(this.lines.length > 400)) {
							for (var t = -1, n = Math.random() > .8 ? .1 : .3, o = Object(f
									.a)(0, 2 * Math.PI), r = []; t < g.camera.position.z;) x
								.x = Math.cos(o) * n, x.y = Math.sin(o) * n, x.z = t, t +=
								.08, o += .025, n += .02, r.push(x.x, x.y, x.z);
